...
dataset = ds.spectrograms.numpy()
dataset = dataset[:, 0:-1:4, 0:-1:4, 0]
dataset = dataset.reshape(dataset.shape[0], -1)

X_train = dataset[:1000,:]
Y_train = dataset[1000:2000,:]
X_test = dataset[2000:2500,:]
Y_test = dataset[2500:3000,:]
...
input_dim_Y = Y_train.shape[1]     # Number of features in Y
hidden_dim = 1000
output_dim = 50
